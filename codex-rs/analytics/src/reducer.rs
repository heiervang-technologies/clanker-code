...
fn collaboration_mode_mode(mode: ModeKind) -> &'static str {
    match mode {
        ModeKind::Plan => "plan",
        // LARP replaced the user-facing Default mode; keep reporting
        // "default" so existing analytics series stay continuous.
        ModeKind::Larp | ModeKind::PairProgramming | ModeKind::Execute => "default",
