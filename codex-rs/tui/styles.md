...
## Exception: collaboration mode indicator

The footer's collaboration mode indicator uses a founder-specified palette
(LARP purple/magenta, Locked In red, Based blue, Cringe orange, Ultrachill
cyan, Plan white) and is exempt from the blue/white/custom-color guidance
above. Keep the exemption scoped to `CollaborationModeIndicator::styled_span`.
