...
pub struct Config {
    ...
    /// Per-mode overrides for built-in collaboration mode presets.
    pub collaboration_modes: HashMap<ModeKind, CollaborationModeOverride>,
...
impl Config {
    ...
    pub(crate) async fn load_config_with_layer_stack(
        ...
        let collaboration_modes = cfg.collaboration_modes.clone().unwrap_or_default();
