...
use codex_protocol::config_types::apply_collaboration_mode_overrides;
...
impl ThreadManager {
    ...
    pub fn new(
        ...
        Self {
            state: Arc::new(ThreadManagerState {
                ...
                session_source,
                installation_id,
                collaboration_mode_overrides: config.collaboration_modes.clone(),
    ...
    pub fn list_collaboration_modes(&self) -> Vec<CollaborationModeMask> {
        apply_collaboration_mode_overrides(
            self.state.models_manager.list_collaboration_modes(),
            &self.state.collaboration_mode_overrides,
        )
    }
