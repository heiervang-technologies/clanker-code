...
pub struct ConfigToml {
    ...
    /// Per-mode overrides for built-in collaboration mode presets, keyed by
    /// mode (e.g. `[collaboration_modes.based]`).
    #[serde(default)]
    pub collaboration_modes: Option<HashMap<ModeKind, CollaborationModeOverride>>,
...
mod tests {
    ...
    #[test]
    fn collaboration_mode_override_keys_accept_canonical_and_legacy_names() {
        let config: ConfigToml = toml::from_str(
            r#"
[collaboration_modes.default]
developer_instructions = "legacy LARP override"
reasoning_effort = "high"
model = "gpt-5.4"

[collaboration_modes.locked_in]
developer_instructions = "locked override"
"#,
        )
        .expect("collaboration mode overrides should deserialize");
            ...
            Some(HashMap::from([
                (
                    ...
                    CollaborationModeOverride {
                        developer_instructions: Some("legacy LARP override".to_string()),
                ...
                (
                    ModeKind::LockedIn,
                    CollaborationModeOverride {
                        developer_instructions: Some("locked override".to_string()),
